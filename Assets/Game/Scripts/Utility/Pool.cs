...
namespace Sins.Utils
{
    public sealed class Pool<T> where T : class
    {
        ...
        {
            if (creator == null) throw new ArgumentException("poolCreator");
            if (initialCount < 0) throw new ArgumentOutOfRangeException("poolInitiialCount", "Initial count cannot be negative!");
